...
void ofApp::draw(){
	...
	if (mode != 0) {
		...
		image.draw(192, 0, 1920, 1080);
	}
	
	ofDrawBitmapStringHighlight("mode "+ofToString(mode), 20, 20);
	ofDrawBitmapStringHighlight("0=no download; 1 = old school; 2 = new school; 3 = ofxFastFboReader"+ofToString(mode), 20, ofGetHeight()-20);
}
